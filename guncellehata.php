   ...
   <a href="index.php">Geri</a></span>	
            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group">
						...
						<a href="guncelle.php?ihtiyac_id=<?=$satir['ihtiyac_id']?>" class="btn btn-secondary">İhtiyacın Bir Kısmını Karşıla</a>
						<a href="sil.php?ihtiyac_id=<?=$satir['ihtiyac_id']?>" onclick="return confirm('Yardım etme işlemi tamamlansın mı?')" class="btn btn-danger">İhtiyacın Tamamını Karşıla</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Hatalı bir değer girdiniz.</h4>
