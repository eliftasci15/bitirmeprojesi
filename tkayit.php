...
{
    include "baglan.php";
    $sql = "INSERT INTO `tedarikciler` (`tedarikcino`, `tedarikciad`, `sehir`, `adres`, `sahipad`, `telefon`, `eposta`, `sifre`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?);";
    $dizi =[
        $_POST["tedarikciad"],
        $_POST["sehir"],
        $_POST["adres"],
...
body{
	...
	border:none;
	outline:none;
	background-image:url(tedarikc.jpg);
...
<body>
   ...
   <a href="main.php">Geri</a></span>
    ...
    <span class="baslik">İhtiyaç Kutusu</span>
		 ...
		 <div class="content">
	 <div class="bilgi">
	 <span class="baslik1">Tedarikçi Kayıt</span>
	 </div>
	 
        <form action="" method="post">
		      <div class="girisEkrani">
			  <span class="ab">İşletme Bilgileri ..................................</span>
                <div class="float:left;">
                <label for="tedarikciad" class="form-label">*</label>
                <input type="text" class="form-control" name="tedarikciad" placeholder="İşletme Adı" required>
                </div>
				...
				<span class="ac">İşletme Sahibi Bilgileri ................</span>
				
				<div class="float:left;">
                <label for="sahipad" class="form-label">*</label>
                <input type="text" class="form-control" name="sahipad" placeholder="İşletme Sahibinin Adı Soyadı" required>
                </div>
				<div class="float:left;">
